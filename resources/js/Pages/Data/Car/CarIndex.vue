    ...
    <section class="px-4 grid gap-4">
        <div>
            ...
            <table class="w-full text-left text-base">
                ...
                <tr v-else>
                    <td colspan="6" class="text-center border-b-2">No Data <Link v-if="props.cars.current_page > 1" class="link link-primary" :href="route('data.car.index')">Goto First Page</Link></td>
                </tr>
                </tbody>
            </table>
