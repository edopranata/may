<template>
    <Head title="Pinjaman Petani" />

    <Breadcrumb :links="breadcrumbs"/>
    <PageTitle :classes="'bg-base-content'">Pinjaman Petani</PageTitle>
...
const breadcrumbs = [
    ...
    {
        "url": null,
        "label": "Petani : " + props.farmer.name
    }
]

const save = () => {
    form.post(route('transaction.loan.farmer.store'), {
        onSuccess: () => {
            set_default_form()
        },
    });
