<template>
    ...
    <PageTitle :classes="'bg-base-content'">Angsuran Pinjaman Supir</PageTitle>
...
const breadcrumbs = [
    ...
    {
        "url": null,
        "label": "Angsuran pinjaman : " + props.driver.name
    }
]
...
const save = () => {
    form.patch(route('transaction.loan.driver.update', props.driver.id), {
        onSuccess: () => {
            set_default_form()
        },
    });
