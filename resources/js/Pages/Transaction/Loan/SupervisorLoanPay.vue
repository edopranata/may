<template>
    <Head title="Angsuran Pinjaman Supervisor" />

    <Breadcrumb :links="breadcrumbs"/>
    <PageTitle :classes="'bg-base-content'">Angsuran Pinjaman Supervisor</PageTitle>
    ...
    <section class="px-4 grid md:grid-cols-2 gap-4">
        <div class="card w-full rounded-none border-2 border-warning shadow-xl">
            <div class="card-body">
                <h2 class="text-xl">Informasi Supervisor</h2>
                <div class="divider my-2"></div>
                <table class="w-full text-left text-base">
                    <tbody>
                    <tr class="group border-b">
                        <th class="group-hover:bg-base-200 py-4 px-6">Nama Supervisor</th>
